...
ActiveRecord::Schema[7.2].define(version: 2026_03_08_225725) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.text "buying_property_address"
    t.text "selling_property_address"
    t.text "requested_services"
    t.string "energy_efficiency_certificate_cee"
    t.string "escritura"
    ...
    t.string "seller_mortgage_status"
    t.text "community_contact_details"
    t.boolean "bank_account_opening"
    t.string "home_tax_id_tin"
